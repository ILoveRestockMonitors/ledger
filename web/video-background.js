...
(async()=>{
 ...
 function allowed(){return !failed&&root.dataset.dragonBg!=='on'&&root.dataset.reviewMode==='custom'&&root.dataset.motionPaused!=='true'&&!reduced.matches&&!document.hidden;}
 ...
 new MutationObserver(sync).observe(root,{attributes:true,attributeFilter:['data-review-mode','data-motion-paused','data-mobile-busy','data-dragon-bg']});
